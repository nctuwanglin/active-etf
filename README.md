...
**自動更新時間**：每交易日台灣 14:20 主跑、18:00 補跑（皆在收盤 13:30 之後）。
排在下午是實測結論——早上公告的那批到下午仍是同一份，下午跑還多拿到盤後才更新的
投信，早上跑沒有獨佔好處。GitHub 排程為 best-effort，實測延遲 1-3 小時。
...
目前已實作 adapter（15 家投信，涵蓋台股主動式 ETF 全部 22 檔）：統一、復華、富邦、群益、
中信、野村、安聯、凱基、台新、永豐、國泰、兆豐、第一金、聯博、摩根。
